...
def main(arg):
    ...
    if arg.mode.lower() == "train":
        train_dataset = load_dataset(os.path.join(data_path, train_path))["train"]
        ...
        valid_dataset = load_dataset(os.path.join(data_path, train_path))["train"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, help="[train] or [eval]", default=None)
