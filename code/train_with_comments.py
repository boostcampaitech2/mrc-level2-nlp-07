...
def main():
    ...
    # do_train 또는 do_eval의 값에 따라 이번 train run의 설정을 변경합니다. 
...
def run_mrc(
    ...
    # 받아온 dataset을 전처리하기 전에, 원 객체의 질문,문맥,정답 행 이름을 받아옵니다. 

    # Padding에 대한 옵션을 설정합니다.
    # (question|context) 혹은 (context|question)로 세팅 가능합니다.
    pad_on_right = tokenizer.padding_side == "right" #길이에 따라 패딩할 때 오른쪽에 패딩 토큰을 추가합니다. 
